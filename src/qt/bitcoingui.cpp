    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Pokemon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pokemon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pokemon: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pokemon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pokemon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pokemon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pokemon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pokemon addresses"));
    ...
    openAction->setStatusTip(tr("Open a pokemon: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pokemon Core help message to get a list with possible Pokemon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pokemon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pokemon network", "", count));
}
...
{
    QString strTitle = tr("Pokemon Core"); // default title
