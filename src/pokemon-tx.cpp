...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pokemon Core pokemon-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pokemon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pokemon transaction") + "\n" +
              "  pokemon-tx [options] -create [commands]   " + _("Create hex-encoded pokemon transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pokemon transaction
