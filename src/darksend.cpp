...
/* *** BEGIN DARKSEND MAGIC - POKEMON **********
    Copyright (c) 2014-2015, Pokemon Developers
        eduffield - evan@pokemon.org
        udjinm6   - udjinm6@pokemon.org
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Pokemon and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizePokemonAmount*COIN - pwalletMain->GetAnonymizedBalance();
...
{
    if(fLiteMode) return; // disable all Pokemon specific functionality
    ...
    RenameThread("pokemon-privatesend");
