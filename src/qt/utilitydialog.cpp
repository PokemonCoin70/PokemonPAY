    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pokemon Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Pokemon Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pokemon-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pokemon Core is shutting down...") + "<br /><br />" +
