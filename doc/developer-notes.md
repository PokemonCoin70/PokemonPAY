...
Pokemon Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Pokemon Core, where everyone uses
...
pay attention to for reviewers of Pokemon Core code.

General Pokemon Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Pokemon Core uses tinyformat, which is type safe. Leave them out to avoid confusion
