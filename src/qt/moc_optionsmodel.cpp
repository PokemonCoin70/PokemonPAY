...
QT_MOC_LITERAL(5, 63, 29),
QT_MOC_LITERAL(6, 93, 19),
QT_MOC_LITERAL(7, 113, 26)
    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "privateSendRoundsChanged\0"
    "anonymizePokemonAmountChanged\0"
    "advancedPSUIChanged\0coinControlFeaturesChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->anonymizePokemonAmountChanged(); break;
        ...
        {
            typedef void (OptionsModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizePokemonAmountChanged)) {
                *result = 2;
            }
        }
        {
...
// SIGNAL 2
void OptionsModel::anonymizePokemonAmountChanged()
{
