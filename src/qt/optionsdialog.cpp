    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("POKEMON-light"), QVariant("light"));
    ui->theme->addItem(QString("POKEMON-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("POKEMON-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("POKEMON-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizePokemon, OptionsModel::AnonymizePokemonAmount);
