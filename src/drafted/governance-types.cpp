...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PokemonNetwork") type = PokemonNetwork;
    if(strType == "PokemonNetworkVariable") type = PokemonNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PokemonNetwork) s = "PokemonNetwork";
    if(type == PokemonNetworkVariable) s = "PokemonNetworkVariable";
