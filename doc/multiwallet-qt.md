...
Only requiring some minor changes is pokemon.cpp.
...
Changes to pokemon.cpp
----------------------
pokemon.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
